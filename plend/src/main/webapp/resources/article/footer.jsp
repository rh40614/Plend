...
<footer class="text-muted py-5" style="background: #2F506D">
  <div class="container" style="display:flex; justify-content: space-between;">
	   	<div class="footer_text">
		    ...
		    <p class="mb-1 "><i class="fa-solid fa-envelope"></i> representative@email.com</p>
	    	...
	    	<a href="https://jealous-gasoline-34d.notion.site/Plend-238f743c7343490081d1364f1e1eeb20" target="blank" rel="noreferrer" style="margin-left: 10px; color: white;"><img style="margin-bottom: 3px;" width="18" height="18" alt="노션" src="<%=request.getContextPath()%>/resources/image/notion.png"></a>
	    </div>
