			          		...
			          		<c:forEach var="img" items="${imgs}" varStatus="status">
						        <c:if test="${status.index eq 0 }">
							        <div class="carousel-item active">
										<img class="bd-placeholder-img bd-placeholder-img-lg d-block " width="606" height="414" alt="img" src="<%=request.getContextPath() %>/reviewImg.do?realFileName=${img.realFileName}"/>
							        </div>
						        </c:if>
